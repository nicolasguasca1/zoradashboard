      ...
      <header>
        <Container maxWidth="container.xl">
          ...
          >
            <Flex py={[4, null, null, 0]} grow={1} alignItems="center">
              ...
              >
                <NavLink
                  to="/buy"
                  style={{
                    padding: ".45rem var(--chakra-space-4)",
                    height: "auto"
                  }}
                >
                  Buy
              ...
              <InputGroup width="21rem">
                ...
                <Input
                  placeholder="Search by licensors or content name"
            ...
            <Tooltip
              label="Your voting power (out of 100%) is dependent on rolling monthly sales of your content"
              aria-label="A tooltip"
            >
              <Button px=".9rem" mr=".6rem">
                <IconFlare stroke={1} style={{ marginRight: ".2rem" }} />4
              </Button>
            </Tooltip>
